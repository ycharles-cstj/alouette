...
class Alouette {
	...
	static public function chanson($oiseau, $qualite, $action, $membres) {
		...
		$resultat .= '<div>Alouette, '.$qualite.' '.$oiseau.'</div>';
		$resultat .= '<div>Alouette, je te '.$action.'.</div>';
		$resultat .= '</div>';
		$resultat .= '</div>';
		$resultat .= '<div class="appel">Je te '.$action.' '.$membres.'</div>';
		$resultat .= '<div class="reponse">Je te '.$action.' '.$membres.'</div>';
